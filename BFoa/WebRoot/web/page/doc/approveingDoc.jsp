				   ...
				   <c:otherwise>
				     <c:forEach items="${appingDocs}" var="flag">
				       <tr>
						...
						<td>查看</td>
						<td><a href="javascript:void(openWindow('bfdoc/doc_openApprove.action?doc_id='+${flag.dom_id},320,160,'open01'))">审批</a>
						/<a href="javascript:void(openWindow('bfdoc/doc_openSubmitDoc.action?doc_id='+${flag.dom_id},320,160,'submit'))">提交</a>
						</td>
				     </tr>
				     </c:forEach>
				   </c:otherwise>
